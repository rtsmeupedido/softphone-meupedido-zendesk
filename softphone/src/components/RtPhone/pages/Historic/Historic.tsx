    ...
    return (
        <Container>
            <StickyHeader>
                ...
                <Input size="middle" type="text" placeholder="Pesquisar..." onChange={(e: any) => setSearch(e.target.value)} />
                {search && (
                    <SearchResults>
                                ...
                                <ItemDetails>
                                    <div className="flex items-center justify-center">
                                        {item.disposition === "ANSWERED" ? (
                                            <Icon className="text-green-500" icon={["mui", "phone_callback"]} />
                                        ) : item.disposition === "NO ANSWER" ? (
                                            <Icon className="text-red-500" icon={["mui", "phone_enabled"]} />
                                        ) : (
                                            <Icon className="text-yellow-500" icon={["mui", "phone_disabled"]} />
                                        )}
                                    </div>
