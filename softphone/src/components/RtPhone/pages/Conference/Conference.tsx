  ...
  return (
    <div className="max-w-2xl mx-auto p-5 ">
      <div className="flex justify-between items-center mb-4">
        ...
        <Tag color={"success"}>
          <StopWatch
            datetime={new Date(conference[0].start_time)}
            isPaused={false}
          />
        </Tag>
      </div>
          ...
          return (
            ...
            >
              <span className="text-lg font-semibold">
                {call.remote_identity.display_name ||
      ...
      {conference.length > 1 && (
        <div className="flex justify-center">
          <Button
            onClick={() => conference.forEach(handleHangUp)}
            type="primary"
            danger
            icon={<PhoneOutlined />}
            className="fixed  mt-60"
          >
